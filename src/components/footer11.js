          ...
          <div className="footer11-newsletter">
            ...
            <div className="footer11-actions">
              ...
              <span>
                {props.content2 ?? (
                  <fragment>
                    <span className="footer11-text08 thq-body-small">
          ...
          <div className="footer11-links">
            <div className="footer11-column1">
              <strong>
                {props.column1Title ?? (
                  <fragment>
                    <span className="footer11-text14 thq-body-large">
                      Contact Us
                    </span>
                  </fragment>
                )}
            ...
            <div className="footer11-column2">
              <strong>
                {props.column2Title ?? (
                  <fragment>
                    <span className="footer11-text thq-body-large">
                      Column Two
                    </span>
                  </fragment>
                )}
            ...
            <div className="footer11-column3">
              <strong>
                {props.socialLinkTitleCategory ?? (
                  <fragment>
                    <span className="footer11-text18 thq-body-large">
                      Connect with Us
                    </span>
                  </fragment>
                )}
