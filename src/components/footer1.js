          ...
          <div className="footer1-newsletter">
            ...
            <div className="footer1-actions">
              ...
              <span>
                {props.content2 ?? (
                  <fragment>
                    <span className="footer1-text08 thq-body-small">
          ...
          <div className="footer1-links">
            <div className="footer1-column1">
              <strong>
                {props.column1Title ?? (
                  <fragment>
                    <span className="footer1-text14 thq-body-large">
                      Contact Us
                    </span>
                  </fragment>
                )}
            ...
            <div className="footer1-column2">
              <strong>
                {props.column2Title ?? (
                  <fragment>
                    <span className="footer1-text thq-body-large">
                      Quick Links
                    </span>
                  </fragment>
                )}
            ...
            <div className="footer1-column3">
              <strong>
                {props.socialLinkTitleCategory ?? (
                  <fragment>
                    <span className="footer1-text18 thq-body-large">
                      Follow Us
                    </span>
                  </fragment>
                )}
