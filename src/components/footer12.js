          ...
          <div className="footer12-newsletter">
            ...
            <div className="footer12-actions">
              ...
              <span>
                {props.content2 ?? (
                  <fragment>
                    <span className="footer12-text08 thq-body-small">
          ...
          <div className="footer12-links">
            <div className="footer12-column1">
              <strong>
                {props.column1Title ?? (
                  <fragment>
                    <span className="footer12-text14 thq-body-large">
                      Contact Us
                    </span>
                  </fragment>
                )}
            ...
            <div className="footer12-column2">
              <strong>
                {props.column2Title ?? (
                  <fragment>
                    <span className="footer12-text thq-body-large">
                      Column Two
                    </span>
                  </fragment>
                )}
            ...
            <div className="footer12-column3">
              <strong>
                {props.socialLinkTitleCategory ?? (
                  <fragment>
                    <span className="footer12-text18 thq-body-large">
                      Follow Us
                    </span>
                  </fragment>
                )}
